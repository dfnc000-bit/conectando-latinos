  ...
  return (
    <section className="bg-cl-bg2 py-16 px-6" id="categorias">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-cl-gray text-sm leading-relaxed max-w-md mx-auto mb-8">
        ...
        <div className="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-12 gap-2.5">
          {CATEGORIAS.map((cat) => {
            ...
            const baseClass = `col-span-1 flex flex-col items-center gap-1.5 rounded-2xl px-2 py-3.5 border transition-all duration-200 cursor-pointer ${
              isActive
                ? 'bg-cl-dark border-cl-dark text-cl-verde2 shadow-lg -translate-y-1'
                : 'bg-white border-cl-gray-light text-cl-gray hover:bg-cl-dark hover:border-cl-dark hover:text-cl-verde2 hover:-translate-y-1 hover:shadow-lg'
            }`
